...
public final class WindowOps {
    ...
    static {
        new Thread(() -> Native.loadLibrary("dwmapi", DwmApi.class, W32APIOptions.DEFAULT_OPTIONS), "AutoTheme-Preload").start();
    }
    ...
    private static void ensureInitialized() {
        ...
        synchronized (WindowOps.class) {
            ...
            DWMApiInstance = Native.loadLibrary("dwmapi", DwmApi.class, W32APIOptions.DEFAULT_OPTIONS);
